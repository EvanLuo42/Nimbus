...
#ifndef MACOSPLATFORM_SWIFT_H
#define MACOSPLATFORM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MacOSPlatform",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("MacOSPlatform", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace MacOSPlatform SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("MacOSPlatform") {
namespace _impl {
extern "C" {
#endif

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_MacOSPlatform_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_MacOSPlatform_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_MacOSPlatform_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_MacOSPlatform_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN void * _Nullable $s13MacOSPlatform7ProgramC12createWindowySvSgs5Int32V_AGSStFZ(int32_t width, int32_t height, struct swift_interop_passStub_MacOSPlatform_uint64_t_0_8_void_ptr_8_16 title, SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // createWindow(_:_:_:)
...
class SWIFT_SYMBOL("s:13MacOSPlatform7ProgramC") Program;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<MacOSPlatform::Program> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_Program;
// Type metadata accessor for Program
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13MacOSPlatform7ProgramCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13MacOSPlatform7ProgramC") Program : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK void * _Nullable createWindow(int32_t width, int32_t height, const swift::String& title) SWIFT_SYMBOL("s:13MacOSPlatform7ProgramC12createWindowySvSgs5Int32V_AGSStFZ");
...
private:
  friend class _impl::_impl_Program;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13MacOSPlatform7ProgramCD;
  static inline constexpr $s13MacOSPlatform7ProgramCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_Program {
public:
static SWIFT_INLINE_THUNK Program makeRetained(void * _Nonnull ptr) noexcept { return Program(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<MacOSPlatform::Program> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return MacOSPlatform::_impl::$s13MacOSPlatform7ProgramCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<MacOSPlatform::Program> { using type = MacOSPlatform::_impl::_impl_Program; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace MacOSPlatform SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("MacOSPlatform") {
  ...
  SWIFT_INLINE_THUNK void * _Nullable Program::createWindow(int32_t width, int32_t height, const swift::String& title) {
  return MacOSPlatform::_impl::$s13MacOSPlatform7ProgramC12createWindowySvSgs5Int32V_AGSStFZ(width, height, MacOSPlatform::_impl::swift_interop_passDirect_MacOSPlatform_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(title)), swift::TypeMetadataTrait<Program>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK bool Program::shouldCloseFlag() {
  return MacOSPlatform::_impl::$s13MacOSPlatform7ProgramC15shouldCloseFlagSbyFZ(swift::TypeMetadataTrait<Program>::getTypeMetadata());
  }
  SWIFT_INLINE_THUNK void Program::pollEvents() {
  MacOSPlatform::_impl::$s13MacOSPlatform7ProgramC10pollEventsyyFZ(swift::TypeMetadataTrait<Program>::getTypeMetadata());
  }
